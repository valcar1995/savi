...
<script type="text/javascript" src="../js/administrador/buAcudiente.js"></script>
...
<div id="todo" style="padding-left:197px;">
    ...
    <div id="contenBusqueda">
        ...
        <div style="text-align:left; display:inline-table">
            ...
            <input type="text" placeholder="Apellidos..." class="filtros" id="campoBuscar" />
