...
if(isset($usuaAnt)){
	...
	if($valido==true){
		...
		header("location:$url?errorAct=no");
		echo '<script type="text/javascript">window.location.href="'.$url.'?errorAct=no";</script>'; 
		
	}
	else{
		header("location:$url?errorAct=si");
		echo '<script type="text/javascript">window.location.href="'.$url.'?errorAct=si";</script>'; 
	}
